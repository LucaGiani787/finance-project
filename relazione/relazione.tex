...
\section*{ii. Cambiamento della correlazione nel tempo}

La correlazione storica dimostra di non essere un parametro statico, bensì una variabile macroeconomica condizionata dal sentiment di mercato:

\begin{itemize}
    \item \textbf{Effetto Shock e Crisi (2020):} In concomitanza con il crollo dei mercati causato dallo scoppio della pandemia da COVID-19, si osserva un repentino picco simultaneo verso l'alto di tutte e tre le serie storiche. Nei momenti di panico finanziario sistemico, i benefici della diversificazione si riducono poiché le correlazioni tendono a convergere verso l'$1$ a causa delle liquidazioni indiscriminate da parte degli investitori.
    \item \textbf{Fase Post-Crisi e Rotazione Settoriale (2021-2026):} A partire dal 2021, le traiettorie si separano nettamente. Mentre il comparto tecnologico e quello automobilistico preservano un legame positivo di fondo, il settore energetico si scollega dal trend principale. Questo fenomeno evidenzia l'impatto delle rotazioni settoriali e dei mutamenti di politica monetaria (es. il ciclo di rialzo dei tassi d'interesse).
\end{itemize}

\section*{iii. Cambiamento delle correlazioni in funzione dei rendimenti}

Dall'analisi congiunta dei grafici a dispersione (\textit{scatter plot}) e delle serie temporali emergono importanti asimmetrie legate all'ampiezza dei rendimenti giornalieri:

\begin{itemize}
    \item \textbf{Rendimenti ordinari:} In condizioni di normale operatività di mercato (rendimenti prossimi allo $0$), le osservazioni si concentrano in una nuvola densa attorno all'origine. In questo regime, i movimenti dei titoli sono dominati da \textit{rumore di fondo} e da fattori idiosidratici legati alle singole aziende, indebolendo la forza della correlazione quotidiana.
    \item \textbf{Rendimenti estremi (Code della distribuzione):} La pendenza positiva delle rette di regressione è fortemente influenzata e stabilizzata dai punti situati alle estremità dei grafici (elevati rendimenti positivi o negativi). Ciò indica che la correlazione settoriale tende ad amplificarsi in presenza di shock macroeconomici o notizie di forte impatto che travolgono l'intero comparto industriale.
\end{itemize}
